...
if __name__ == '__main__':
    import time
    mplier = input("What brightness do you want 1-100: ")
    mplier = int(mplier)
    mplier = float(mplier / 100)
    while True:
        red = (random.random())
        green = (random.random())
        blue = (random.random())
        ...
        green = green * mplier
        blue = blue * mplier
        print("Current Colour: R:", int(red * 255), " G:", int(green * 255), " B:", int(blue * 255))
        for i in range(255):    
            pixels[0, :] = red * i  # Set 1st pixel red
            pixels[1, :] = green * i # Set 2nd pixel green
            pixels[2, :] = blue * i #  Set 3rd pixel blue   
            update()
            time.sleep(0.005)
        time.sleep(1)
        for i in range(255):    
            pixels[0, :] = red * (255- i)  # Set 1st pixel red
            pixels[1, :] = green * (255- i) # Set 2nd pixel green
            pixels[2, :] = blue * (255- i) # Set 3rd pixel blue   
            update()
            time.sleep(0.005)
